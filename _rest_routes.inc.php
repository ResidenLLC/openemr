...
RestConfig::$ROUTE_MAP = array(
    ...
    /**
     *  @OA\Post(
     *      path="/api/patient/{pid}/encounter/{eid}/payment",
     *      description="Record a payment (or refund) for a specific encounter.",
     *      tags={"standard"},
     *      @OA\Parameter(
     *          name="pid",
     *          in="path",
     ...
     *              mediaType="application/json",
     *              @OA\Schema(
     *                  required={"amount", "method", "source"},
     *                  properties={
     *                      @OA\Property(property="amount", type="number", format="float", description="The payment amount. Use negative for refund."),
     *                      @OA\Property(property="method", type="string", description="Payment method, e.g. credit_card."),
     *                      @OA\Property(property="source", type="string", description="Reference or transaction id (e.g. Stripe txn id)."),
     *                      @OA\Property(property="description", type="string", description="Optional description or notes.")
     *                  },
     *                  example={"amount":50.00,"method":"credit_card","source":"stripe_txn_123456","description":"Stripe Terminal Payment"}
     *              )
     *          )
     *      ),
     *      @OA\Response(
     ...
     *  )
     */
    "POST /api/patient/:pid/encounter/:eid/payment" => function ($pid, $eid) {

        RestConfig::authorization_check("patients", "appt");
        $data = (array) (json_decode(file_get_contents("php://input")));
        $return = (new PaymentRestController())->postPayment($pid, $eid, $data);
        RestConfig::apiLog($return, $data);
        return $return;
    },
